...
import online.teaplanter.backend.repository.FactoryRepository;
import online.teaplanter.backend.repository.TeaDeliveryRepository;
...
public class FactoryService {
    ...
    public TeaDelivery recordDelivery(TeaDelivery delivery, Long plantationId) {
        ...
        List<online.teaplanter.backend.entity.Harvest> dailyHarvests = (delivery.getPlantation() != null)
